...
class SentimentNetwork:
	...
	def sigmoid_ouput_2_derivative(self, output):
	...
	def train(self, training_reviews_raw, training_labels):
		...
		for review in training_reviews_raw:
			...
			training_reviews.append(list(indices)) #  existing values correspone to the posiotion
		...
		for i in range(len(training_reviews)):
			...
			layer_2_delta = layer_2_error * self.sigmoid_ouput_2_derivative(layer_2)

			#  Back propagation error
			layer_1_error = layer_2_delta.dot(self.weights_1_2.T)
			layer_1_delta = layer_1_error

			#  Update hidden 2 output 
